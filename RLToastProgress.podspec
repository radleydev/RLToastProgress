...
This CocoaPods library helps you show loading when fetching API or show message by toaster. All in one.
  ...
  # Or just: spec.author    = "radleydev"
  # spec.authors            = { "radleydev" => "radley.dev@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/radleydev"
  ...
  spec.source       = { :git => "http://EXAMPLE/RLToastProgress.git", :tag => "#{spec.version}" }
